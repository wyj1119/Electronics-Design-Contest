...
void AD9833_Init_GPIO(void)
{
    ...
    MAP_GPIOPinTypeGPIOOutput(GPIO_PORTK_BASE, (GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_3));
    MAP_GPIOPinWrite(GPIO_PORTK_BASE, (GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_3), 0);
}
